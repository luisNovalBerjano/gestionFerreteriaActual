...
public class DocumentoJpaController implements Serializable {
    ...
    public void edit(Documento documento) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Documento persistentDocumento = em.find(Documento.class, documento.getId_documento());
            ...
            if (msg == null || msg.length() == 0) {
                Long id = documento.getId_documento();
                if (findDocumento(id) == null) {
                    throw new NonexistentEntityException("EL documento con id " + id + " no existe.");
                }
            }
            throw ex;
        } finally {
