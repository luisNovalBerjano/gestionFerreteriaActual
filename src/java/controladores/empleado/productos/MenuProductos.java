 ...
 * @author luisn
 */
@WebServlet(name = "MenuProductos", urlPatterns = {"/empleado/MenuProductos"})
public class MenuProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/empleado/productos/menuProductos.jsp";
        ...
        request.setAttribute("productos", djc.findProductoEntities()); //Mandamos los productos a la vista
