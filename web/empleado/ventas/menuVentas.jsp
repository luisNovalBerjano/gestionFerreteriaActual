<%-- 
    ...
    Created on : 07-nov-2023, 19:47:31
    Author     : luisn
--%>
                    ...
                    <div class="container" >
                        ...
                        <div class="collapse navbar-collapse text-white"  id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="./MenuVentas">Ventas</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                </li>  <a class="nav-link text-white" href="./../EditarPerfil">Editar Perfil       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
 <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
</svg></a>
    ...
    <div class="container" id="margen">
        ...
        <a class="btn btn-primary mt-3" href="CrearVenta">Crear Nueva Venta</a>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                <c:forEach items="${ventas}" var="v">
                    <tr>
                        <td><c:out value="${v.id_cliente.id_usuario.nombreCompleto}"/></td>
                        <td><c:out value="${v.id_usuario.nombreCompleto}"/></td>
                        <td><c:out value="${v.precio_bruto} €"  /></td>
                        
                        
                        <td>
                            <form action="AnularVenta" method="post">
                                <input type="hidden" name="id_producto" value="${v.id_venta}">
