    ...
    <body>
        ...
        <header>
                    ...
                    <div class="container" >
                        ...
                        <div class="collapse navbar-collapse text-white"  id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="./empleado/MenuClientes">Clientes</a>
                                </li>
                                <li class="nav-item">
            ...
            <c:if test="${usuario.rol == 'empleado'}">
               ...
               <li class="nav-item">
                                    <a class="nav-link text-white" href="EditarPerfil">Editar Perfil       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                ...
                <nav class="navbar navbar-expand-lg " style="background-color: #3D55A2">
                    <div class="container" >
                        ...
                        <div class="collapse navbar-collapse text-white"  id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="">Mis Documentos</a>
                                </li>
                                <a class="nav-link text-white" href="EditarPerfil">Editar Perfil       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
 <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
    ...
    <!-- Agrega este bloque para el slider -->
  ...
  <div class="banner-row">
    <div class="banner text-center" id="banner1">
        <img src="imagenes/electricidad3-big.jpg" alt="Categoria 1">
        <div class="overlay">
            <p>Proyectos</p>
        </div>
    </div>
    ...
    <div class="banner text-center" id="banner2">
        <img src="imagenes/navidad.png" alt="Categoria 2">
        <div class="overlay">
            <p>Navidad</p>
        </div>
    </div>
...
<div class="banner-row">
    <div class="banner text-center" id="banner3">
        <img src="imagenes/llaves.png" alt="Categoria 3">
        <div class="overlay">
            <p>Copia de llaves</p>
        </div>
    </div>

    <div class="banner text-center" id="banner4">
        <img src="imagenes/bombi.png" alt="Categoria 4">
        <div class="overlay">
            <p>Iluminacion</p>
        </div>
    </div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3170.6015698680676!2d-5.976044623670455!3d37.37560343505287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd126e9a1a91e437%3A0x55cae7914dfb618f!2sFerreteria%20La%20El%C3%A9ctrica%20Del%20Hogar!5e0!3m2!1ses!2ses!4v1702122578014!5m2!1ses!2ses" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
